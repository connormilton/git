# First, create a directory for the LLM prompts
import os

# Create the llm_prompts directory if it doesn't exist
if not os.path.exists('llm_prompts'):
    os.makedirs('llm_prompts')
    print("Created llm_prompts directory")

# Create the advanced_trade_analysis.txt template file
template_content = """# Advanced Market Analysis & Trading Recommendations
...
with open('llm_prompts/advanced_trade_analysis.txt', 'w') as f:
    f.write(template_content)
    print("Created advanced_trade_analysis.txt template file")